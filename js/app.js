...
const showProducts = (products) => {
  for (const product of products) {
    ...
    div.innerHTML = `<div class="single-product p-3 card">
    ...
    <div>
      ...
      <button onclick="addToCart(${product.price})" id="addToCart-btn" type="button" class="btn btn-outline-success">Add to cart</button>
